...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // if profile field doesn't exit, make exmpty string
      profile.skills = skillCSV;
      profile.company = !isEmpty(profile.location) ? profile.location : "";
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique handle for your profile URL. Your full name, location name, nickname"
                />
                <SelectListGroup
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  info="Could be your own location or one you work fore"
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
